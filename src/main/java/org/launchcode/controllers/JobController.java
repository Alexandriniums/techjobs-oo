...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors, RedirectAttributes attributes) {
        ...
        if (errors.hasErrors()) {
            ...
            PositionType jobPos = jobData.getPositionTypes().findById(jobForm.getPositionTypesId());
            CoreCompetency jobCore = jobData.getCoreCompetencies().findById(jobForm.getCoreCompetenciesId());

            Job newJob = new Job(jobName, jobEmp, jobLoc, jobPos, jobCore);
